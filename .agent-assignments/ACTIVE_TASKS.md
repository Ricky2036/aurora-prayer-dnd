...
| Merged | Antigravity | Standardize controls across Settings pages (ListCell enhancements, AppNavBar, ToggleSwitch unification in SettingsNotifications) | `antigravity/lane` | `src/components/ui/ListCell.vue`; `src/components/apps/settings/SettingsNotifications.vue` | `12dc58d` | `19e4ad5` |
