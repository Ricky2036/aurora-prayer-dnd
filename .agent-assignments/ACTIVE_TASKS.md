...
| Active | Antigravity | Independent apps and integration | `antigravity/lane` plus integration worktree | `src/components/apps/**`; `src/components/phone/ScreenView.vue`; app-specific stores/assets/tests; integration-only shared registration files | `232b5bc` | — |
